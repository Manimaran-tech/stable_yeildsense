        ...
        >
                ...
                >
                    ...
                    <div className="mb-10 px-6">
                        ...
                        <TextReveal className="text-xl text-gray-300 leading-relaxed mt-1" blockColor="#00F0FF" delay={0.8}>
                            <span>
                                Powered by <span className="text-cyan-400 font-semibold">Inco FHE</span> for total financial sovereignty.
                            </span>
                        </TextReveal>
                    </div>
            ...
            <section className="section-immersive">
                <div className="reveal max-w-4xl text-center mb-12">
                    ...
                    <div className="mt-4">
                        <TextReveal className="text-lg text-gray-400 leading-relaxed" blockColor="#8b5cf6">
                            <span>Yield Sense utilizes <span className="text-purple-400">Confidential Computation</span> to decouple your identity from your liquidity positions.</span>
                        </TextReveal>
                    </div>
                </div>
                ...
                <div className="feature-grid cursor-default">
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold mb-3 text-white">FHE Encryption</h3>
                        <p className="text-gray-400 leading-relaxed">Your deposit amounts and profit ratios are encrypted on-chain using Inco's Fully Homomorphic Encryption.</p>
                    </motion.div>
            ...
            <section className="section-immersive text-center">
                ...
                <p className="text-gray-500 font-mono text-sm tracking-[0.2em] uppercase">
                    Secured by Inco Network & Whirlpool Protocol
                </p>
            </section>
        </motion.div>
    );
